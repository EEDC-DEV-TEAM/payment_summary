  ...
  // const url = 'mongodb://74.208.223.31:27017'
    ...
    (async function() {
        ...
        try {
            ...
            let monthData ={total:0,ppmCount:0,postpaidCount:0,ppmAmount:0,postpaidAmount:0};//change here
                ...
                monthArray.map(data=>{
                 ...
                 monthArray.map(data=>{
                    if(data._id==='Postpaid'){
                        ...
                        monthData.ppmAmount=Math.trunc(data.total);//change here
                })
            }

           var result = {district:district,transactions: queryResult[0].transactions,daytotal:queryResult[0].daytotal,mtd:monthData.total,mtdPrepaidCount:monthData.ppmCount + "/N" + monthData.ppmAmount.toLocaleString('en-GB') ,
            mtdPostpaidCount:monthData.postpaidCount + "/N" + monthData.postpaidAmount.toLocaleString('en-GB')};
...
router.get('/allcollections', function(req, res, next) {
    ...
    (async function() {
        ...
        try {
            ...
            let monthData ={total:0,ppmCount:0,postpaidCount:0,ppmAmount:0,postpaidAmount:0};
            ...
            var result = {transactions: queryResult[0].transactions,daytotal:queryResult[0].daytotal,mtd:monthData.total,mtdPrepaidCount:monthData.ppmCount  + "/N" + monthData.ppmAmount.toLocaleString('en-GB'),
            mtdPostpaidCount:monthData.postpaidCount + "/N" + monthData.postpaidAmount.toLocaleString('en-GB')};
